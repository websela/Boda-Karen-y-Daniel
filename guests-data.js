 ...
 * ================================================================
 * Generada a partir de tu archivo LISTAFINAL.xlsx (54 invitados).
 *
 * Campos por invitado:
...
let GUEST_LIST = [
  ...
  { id: "g02", nombre: "Victor Vasquez", acompanantesPermitidos: 1, acompanantesNombres: ["Sandra Drada"], ninosPermitidos: 1, ninosNombres: ["Sara Vasquez"], tipo: "Familia Novio" },
  ...
  { id: "g10", nombre: "Juan David Ospina", acompanantesPermitidos: 0, acompanantesNombres: [], ninosPermitidos: 0, ninosNombres: [], tipo: "Familia Novio" },
  ...
  { id: "g12", nombre: "Jessica Perez", acompanantesPermitidos: 0, acompanantesNombres: [], ninosPermitidos: 1, ninosNombres: ["Abigail Perez"], tipo: "Familia Novio" },
  { id: "g13", nombre: "Edwar Perez", acompanantesPermitidos: 1, acompanantesNombres: ["Mateo Perez"], ninosPermitidos: 0, ninosNombres: [], tipo: "Familia Novio" },
  ...
  { id: "g17", nombre: "Isabella Clavijo", acompanantesPermitidos: 0, acompanantesNombres: [], ninosPermitidos: 0, ninosNombres: [], tipo: "Trabajo" },
  ...
  { id: "g24", nombre: "Jefry Getial", acompanantesPermitidos: 1, acompanantesNombres: ["Dayana Parra"], ninosPermitidos: 0, ninosNombres: [], tipo: "Amigos" },
  { id: "g25", nombre: "Hoover Cruz", acompanantesPermitidos: 1, acompanantesNombres: ["Felipe Cruz"], ninosPermitidos: 0, ninosNombres: [], tipo: "Amigos" },
  { id: "g26", nombre: "Henry cardona", acompanantesPermitidos: 1, acompanantesNombres: ["Nicole Salgado"], ninosPermitidos: 0, ninosNombres: [], tipo: "" },
  { id: "g27", nombre: "Alfonso Rosero", acompanantesPermitidos: 2, acompanantesNombres: ["Mariluz Montoya", "Samuel rosero"], ninosPermitidos: 0, ninosNombres: [], tipo: "Familia Novia" },
  { id: "g28", nombre: "Jhon Wilber Rosero", acompanantesPermitidos: 1, acompanantesNombres: ["Regina Perdomo"], ninosPermitidos: 1, ninosNombres: ["Joaquin Rosero"], tipo: "Familia Novia" },
  { id: "g29", nombre: "Lady Cardona", acompanantesPermitidos: 1, acompanantesNombres: ["Leonardo Ruiz"], ninosPermitidos: 0, ninosNombres: [], tipo: "Amigos" },
  { id: "g30", nombre: "Valeria Ortiz", acompanantesPermitidos: 1, acompanantesNombres: ["Luis Maldonado"], ninosPermitidos: 0, ninosNombres: [], tipo: "Trabajo" },
  ...
  { id: "g37", nombre: "Heberth Diaz", acompanantesPermitidos: 2, acompanantesNombres: ["Ximena Eusse", "Maria Jose Diaz"], ninosPermitidos: 0, ninosNombres: [], tipo: "Familia Novia" },
  ...
  { id: "g44", nombre: "Marleny Rosero", acompanantesPermitidos: 1, acompanantesNombres: [], ninosPermitidos: 0, ninosNombres: [], tipo: "Familia Novia" },
  ...
  { id: "g53", nombre: "Luis Rengifo", acompanantesPermitidos: 0, acompanantesNombres: [], ninosPermitidos: 0, ninosNombres: [], tipo: "Amigos" },
  { id: "g54", nombre: "Karolay Montoya Marin", acompanantesPermitidos: 1, acompanantesNombres: ["Andres Felipe Espitia"], ninosPermitidos: 1, ninosNombres: ["Isabella Espitia Montoya"], tipo: "Familia Novia" },
];
